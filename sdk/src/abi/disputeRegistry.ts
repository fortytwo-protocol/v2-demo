// FTDisputeRegistry ABI. Hand-maintained mirror of the corresponding contract
// in ft-contracts (apply changes from there when the ABI shifts).

export const FT_DISPUTE_REGISTRY_ABI = [
  {
    "type": "constructor",
    "inputs": [
      {
  ...
  {
    "type": "function",
    "name": "getDisputeAncillaryUpdates",
    "inputs": [
      {
        "name": "questionId",
        "type": "bytes32",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple[]",
        "internalType": "struct FTDisputeRegistry.DisputeAncillaryDataUpdate[]",
        "components": [
          {
            "name": "timestamp",
            "type": "uint256",
  ...
  {
    "type": "function",
    "name": "getDisputeAncillaryUpdatesPaginated",
    "inputs": [
      {
        "name": "questionId",
        "type": "bytes32",
  ...
  {
    "type": "function",
    "name": "getLatestDisputeAncillaryUpdate",
    "inputs": [
      {
        "name": "questionId",
        "type": "bytes32",
  ...
  {
    "type": "error",
    "name": "DRegistryInvalidQuestion",
    "inputs": []
  },
  {
    "type": "error",
    "name": "DRegistryLimitIsZero",
    "inputs": []
  },
  {
    "type": "error",
    "name": "DRegistryQuestionAlreadyFinalised",
    "inputs": []
  },
  {
    "type": "error",
    "name": "DRegistryQuestionNotResolved",
    "inputs": []
  },
  {
    "type": "error",
  ...
  {
    "type": "error",
    "name": "RegistryExceedMaxAncillaryDataUpdateLength",
    "inputs": []
  }
] as const;
