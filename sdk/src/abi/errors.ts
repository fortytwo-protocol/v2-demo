...
export const V2_ERROR_ABI = [
  ...
  {
    type: "error",
    name: "RegistryQuestionIsFlagged",
    inputs: [],
  },
  {
    type: "error",
    name: "RegistryAlreadyFlagged",
    inputs: [],
  },
  {
    type: "error",
    name: "RegistryNotFlagged",
    inputs: [],
  },
  {
    type: "error",
    name: "RegistryManualFinaliseTooEarly",
    inputs: [],
  },
  {
    type: "error",
    name: "RegistryOutcomeImagesMismatch",
    inputs: [],
  },
  {
    type: "error",
    name: "RegistryOutcomeLengthMismatch",
    inputs: [],
  },
  {
    type: "error",
    name: "RegistryInvalidNumOutcomes",
    inputs: [],
  },
  {
    type: "error",
